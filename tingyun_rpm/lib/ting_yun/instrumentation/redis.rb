  ...
  executes do
    ...
    ::Redis::Client.class_eval do
      ...
      def call_with_tingyun_trace(*args, &blk)
        ...
        TingYun::Agent::Datastore.wrap("Redis", operation, nil, host, port, method(:record_redis_duration)) do
      ...
      if public_method_defined? :connect
        ...
        def connect(*args, &block)
          TingYun::Agent::Datastore.wrap("Redis", "connect", nil, host, port, method(:record_redis_duration)) do
