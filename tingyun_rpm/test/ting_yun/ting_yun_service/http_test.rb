...
class TingYun::TingYunService
  class HttpTest < Minitest::Test
    ...
    def test_uri_with_sym_method
      ...
      assert_equal "/test?licenseKey=123&version=789&appSessionKey=456" ,remote_method_uri(:test)
    end
    ...
    def test_uri_with_nil
      ...
      assert_equal "/?licenseKey=123&version=789&appSessionKey=456" ,remote_method_uri(nil)
    end
